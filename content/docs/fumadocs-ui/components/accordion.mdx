...
<AutoTypeTable path="./content/docs/fumadocs-ui/components/props.ts" name="AccordionsProps" />

### Accordion

<AutoTypeTable path="./content/docs/fumadocs-ui/components/props.ts" name="AccordionProps" />
