...
The source of your content, can be a CMS or local data layers like [Fumadocs MDX](https://fumadocs.dev/docs/mdx) (the official content source).
...
<Callout title="Want to learn more?">
  Read our in-depth [What is Fumadocs](https://fumadocs.dev/docs/ui/what-is-fumadocs) introduction.
</Callout>
...
<Callout title='From Existing Codebase?'>
  ...
  You can follow the [Manual Installation](https://fumadocs.dev/docs/ui/manual-installation) guide to get started.
...
```
    ...
    <Accordion id='multi-docs' title="How to implement multi-docs?">
        We recommend to use [Sidebar Tabs](https://fumadocs.dev/docs/ui/navigation/sidebar#sidebar-tabs).
    </Accordion>
...
<Accordions>
  <Accordion id='dynamic-route' title="It uses Dynamic Route, will it be poor in performance?">
    ...
    You can [enable Static Exports](https://fumadocs.dev/docs/ui/static-export) on Next.js to get a static build output.
...
<Cards>
  <Card href="https://fumadocs.dev/docs/ui/markdown" title="Markdown">
    Fumadocs has some additional features for authoring content.
  </Card>
  <Card href="https://fumadocs.dev/docs/ui/navigation" title="Navigation">
    Learn how to customise navigation links and sidebar items.
  </Card>
  <Card href="https://fumadocs.dev/docs/ui/page-conventions" title="Routing">
...
<Cards>
  <Card
    href="https://fumadocs.dev/docs/ui/static-export"
    title="Configure Static Export"
    description="Learn how to enable static export on your docs"
  />
  <Card
    href="https://fumadocs.dev/docs/ui/internationalization"
  ...
  />
  <Card
    href="https://fumadocs.dev/docs/ui/customisation"
    title="Customise UI"
