...
<DocsCategory url="/docs/get-started/markdown" />
...
You can configure & use the [built-in components](/docs/fumadocs-ui/components) in your MDX document, such as Tabs, Accordions and Zoomable Image.
